...
<div class="col-md-12">
    <div class="card card-outline card-info">
        ...
        <div class="card-body">
            ...
            <p>
                <a class="btn btn-sm btn-primary" href="<?php echo base_url(); ?>/semester/tambah"><i class="fa-solid fa-user-plus"></i> Tambah Guru</a>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-warning" href="<?php echo base_url(); ?>/semester/edit/<?php echo $r['id_guru']; ?>"><i class="fa-solid fa-edit"></i> Edit</a>
